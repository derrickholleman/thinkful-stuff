...
function App() {
  ...
  return (
    <div>
      <Header name={name} birthday={birthday} image={imageSrc}/>
      { hobbies.length > 0 && <HobbyList hobbies={hobbies}/>}
      {dailyActivities.length > 0 && <ActivityList dailyActivities={dailyActivities}/>}
    </div>
  );
}
